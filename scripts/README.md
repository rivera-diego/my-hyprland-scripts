...
3. Add bindings to your `keybinds.conf`:
   ...
   ```ini
   # Smart Launchers
   bind = SUPER, T, exec, ~/.config/hypr/scripts/apps/focus-or-launch-ghostty.sh
   bind = SUPER, B, exec, ~/.config/hypr/scripts/apps/focus-or-launch-vivaldi.sh

   # Window Management
   bind = SUPER, Q, exec, ~/.config/hypr/scripts/windows/kill-active.sh
   bind = SUPER, Tab, exec, ~/.config/hypr/scripts/monitors/monitor-switch.sh
   bind = SUPER, mouse:276, exec, ~/.config/hypr/scripts/monitors/toggle-monitor.sh
   bind = SUPER, F12, exec, ~/.config/hypr/scripts/monitors/swap-content.sh

   # Screenshots
   bind = SUPER SHIFT, S, exec, ~/.config/hypr/scripts/capture/screenshot-editor.sh
   bind = SUPER SHIFT, O, exec, ~/.config/hypr/scripts/capture/screenshot-ocr.sh
   ```
